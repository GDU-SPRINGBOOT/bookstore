    ...
    <div>
        ...
        <AccordionDetails>
          ...
          <ul>
            <li>
              ...
              <Typography>• Triển khai Docker</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
        ...
        <Typography>Đảm nhận công việc:</Typography>
          <ul>
            <li>
              ...
              <Typography>• Mô tả Use Case</Typography>
              <Typography>• Thiết kế Backend</Typography>
              <Typography>• Thiết kế cơ sở dữ liệu</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
        ...
        <Typography>Đảm nhận công việc:</Typography>
          <ul>
            <li>
              ...
              <Typography>• Mô tả Use Case</Typography>
              <Typography>• Thiết kế Backend</Typography>
              <Typography>• Triển khai AWS</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
        ...
        <Typography>Đảm nhận công việc:</Typography>
          <ul>
            <li>
              <Typography>• Use Case</Typography>
              <Typography>• Mô tả Use Case</Typography>
              <Typography>• Thiết kế UI Customer</Typography>
              <Typography>• Thực hiện các chức năng của Customer</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
      ...
      >
        ...
        <Typography>Đảm nhận công việc:</Typography>
          <ul>
            <li>
              <Typography>• Use Case tổng quát</Typography>
              <Typography>• Thiết kế UI Login, Register</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
        ...
        <Typography>Đảm nhận công việc:</Typography>
          <ul>
            <li>
              <Typography>• Use Case</Typography>
              <Typography>• Mô tả Use Case</Typography>
              <Typography>• Thiết kế UI Admin</Typography>
              <Typography>• Thực hiện các chức năng của Admin</Typography>
            </li>
          </ul>
        </AccordionDetails>
      </Accordion>
